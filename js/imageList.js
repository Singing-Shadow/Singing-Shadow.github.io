...
// //添加标签
// function appendLabel(elementId) {
//   document.getElementById("item").appendChild();
...
// }
// //检测判断添加、删除标签
// function changeElementByIdOnMobile(elementId) {
//   // 检查视口宽度是否小于视口高度，或视口宽度小于768px
...
//     // 检查元素是否存在
//     if (element) {
//       console.log(`元素 ${elementId} 已存在`);
//     } else {
//       appendLabel();
//       console.log(`元素 ${elementId} 已添加`);
//     }
//   }
// }
...
//   changeElementByIdOnMobile('label');
// });
